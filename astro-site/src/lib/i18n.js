...
export const LIVE_ES_PATHS = new Set([
  ...
  '/es/screen-rooms-lanais-tampa-fl/',
  '/es/reparacion-canaletas-tampa-fl/',
  '/es/reparacion-urgente-canaletas-tampa-fl/',
  '/es/inspeccion-canaletas-tampa-fl/',
  '/es/reemplazo-canaletas-tampa-fl/',
  '/es/protectores-canaletas-tampa-fl/',
  '/es/limpieza-canaletas-tampa-fl/',
  '/es/mantenimiento-canaletas-tampa-fl/',
  '/es/canaletas-comerciales-tampa-fl/',
  '/es/canaletas-residenciales-tampa-fl/',
  '/es/canaletas-semicirculares-tampa-fl/',
  '/es/canaletas-cobre-tampa-fl/',
  '/es/canaletas-personalizadas-tampa-fl/',
  '/es/colores-canaletas-tampa-fl/',
  '/es/bajantes-tampa-fl/',
  '/es/drenaje-subterraneo-tampa-fl/',
